...
############## BTC modification - pull additional intarna parameters ###########
my $intaparams = `grep 'additional intarna params:' CopraRNA_option_file.txt | sed 's/additional intarna params://g'`;
chomp $intaparams;
...
open(MYDATA, $ncrnas) or die("\nError: cannot open file $ncrnas in mod_prepare_intarna_out.pl\n\n"); ## edit 2.0.5.1 // added script name
